<template>
  ...
  >
    <el-form
      ...
      label-width="100px"
    >
      <el-form-item label="上級選單" prop="parent_id">
        <el-select v-model="form.parent_id" placeholder="請選擇上級選單">
      ...
      <el-form-item label="選單類型" prop="menu_type" label-width="100px">
      ...
      <el-form-item label="路由位址" prop="component">
      ...
      <el-form-item label="顯示順序" prop="order_num" >
					<el-input-number v-model="form.order_num" :min="1" label="顯示順序"></el-input-number>
      </el-form-item>
...
const rules = ref({
  parentId:[
    { required: true, message: '請選擇上級選單'}
  ],
  name: [{ required: true, message: "選單名稱不得空白", trigger: "blur" }]
})
